...
| [`docs/architecture.md`](docs/architecture.md) | The software architecture of LAYUP: the engine's commands, the runner (the LAYUP App), the state data model, the role model, the escalation rule, the stall procedure and the telemetry record, resting on `PRD-0001` and ADR-0010 to ADR-0017. |
